...
import affichage.CaptureView;
import affichage.ChatView;
...
public class Server {
    ...
    public void ListenData(ChatView chatView) {
        try {
            ...
            chatView.AddMessage(inputData.readUTF());
        } catch (IOException ex) {
    ...
    public static ChatView chatvie (){
    ...
    public static void main(String [] args) {
        Server server = new Server(chatvie()) ;
    }
}